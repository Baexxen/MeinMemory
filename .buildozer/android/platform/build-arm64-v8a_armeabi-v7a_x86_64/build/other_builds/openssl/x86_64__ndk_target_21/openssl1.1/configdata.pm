...
our %config = (
  ...
  CPPFLAGS => [ "-DANDROID -I/home/backe/.buildozer/android/platform/android-ndk-r25b/toolchains/llvm/prebuilt/linux-x86_64/sysroot/usr/include -I/home/backe/Python/Projekte/MeinMemory/.buildozer/android/platform/build-arm64-v8a_armeabi-v7a_x86_64/build/python-installs/meinmemory/x86_64/include/python3.1" ],
  CPPINCLUDES => [  ],
  CXX => "/usr/bin/ccache /home/backe/.buildozer/android/platform/android-ndk-r25b/toolchains/llvm/prebuilt/linux-x86_64/bin/clang++ -target x86_64-linux-android21 -fomit-frame-pointer -march=x86-64 -msse4.2 -mpopcnt -m64 -fPIC",
