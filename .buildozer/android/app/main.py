...
class MainMenuScreen(Screen):
    ...
    def update_top_label(self):
        ...
        self.top_label.text = f"current_theme: {current_theme}, Current System: {current_system}"
...
class MyMemoryApp(App):
    ...
    def on_start(self):
        ...
        print(f"Plattform: {current_platform}")
        self.dark_theme = is_dark_theme()
        print(f"{self.dark_theme}")
